import "./HealthyFeatureStyles.css";
...
function HealthyFeature() {
  ...
  React.useEffect(() => {
    ...
    timeoutRef.current = setTimeout(
      () =>
        setIndex((prevIndex) =>
          prevIndex === HealthyData.length - 1 ? 0 : prevIndex + 1
        ),
      delay
    );
    return () => {
...
//setTimeout(HealthyFeature(), 3000)

export default HealthyFeature;
